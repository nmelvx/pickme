...
class PhpDumper extends \MailPoetVendor\Symfony\Component\DependencyInjection\Dumper\Dumper
{
    ...
    public function dump(array $options = array())
    {
        ...
        $options = \array_merge(array('class' => 'ProjectServiceContainer', 'base_class' => 'Container', 'namespace' => '', 'as_files' => \false, 'debug' => \true, 'hot_path_tag' => 'container.hot_path', 'inline_class_loader_parameter' => 'container.dumper.inline_class_loader', 'build_time' => \time()), $options);
        ...
        (new \MailPoetVendor\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass(\false))->process($this->container);
...
EOF;
    ...
    private function addService($id, \MailPoetVendor\Symfony\Component\DependencyInjection\Definition $definition, &$file = null)
    {
        ...
        $this->definitionVariables[$definition] = $this->referenceVariables[$id] = new \MailPoetVendor\Symfony\Component\DependencyInjection\Variable('instance');
        $return = array();
        if ($class = $definition->getClass()) {
            ...
            if (\is_string($factory)) {
                ...
                if (\is_string($factory[0]) || $factory[0] instanceof \MailPoetVendor\Symfony\Component\DependencyInjection\Reference) {
                    $return[] = \sprintf('@return object An instance returned by %s::%s()', (string) $factory[0], $factory[1]);
                } elseif ($factory[0] instanceof \MailPoetVendor\Symfony\Component\DependencyInjection\Definition) {
...
EOF;
        ...
        $this->addInlineVariables($head, $tail, $id, $arguments, \true);
        $code .= '' !== $head ? $head . "\n" : '';
...
, 'services', $id);
    ...
    private function addInlineService(&$head, &$tail, $id, \MailPoetVendor\Symfony\Component\DependencyInjection\Definition $definition, $forConstructor)
    {
        ...
        $name = $this->getNextVariableName();
        $this->definitionVariables[$definition] = new \MailPoetVendor\Symfony\Component\DependencyInjection\Variable($name);
        $code = '';
